// -----------------------------------------------------------------------------
// <copyright file="ExchangeBuilder" company="Matt Scheetz">
//     Copyright (c) Matt Scheetz All Rights Reserved
// </copyright>
// <author name="Matt Scheetz" date="2/15/2019 5:07:24 PM" />
// -----------------------------------------------------------------------------
...
namespace coinbot.strategies.zzz_Old_Bot
{
    ...
    public class ExchangeBuilder : IExchangeBuilder
    {
        ...
        private OrderResponse[] KuCoinOpenOrderDetailToOrderReponse(KuCoinEntities.OpenOrderDetail[] openOrderDetails, TradeType tradeType)
        {
        ...
        private OrderBook KuCoinOrderBookToOrderBook(KuCoinEntities.OrderBookResponse orderBookResponse)
        {
        ...
        private BinanceOrders[] KuCoinOrdersToBinanceOrders(KuCoinEntities.OrderBook[] kuOrders)
        {
        ...
        private OrderBook GDAXOrderBookToOrderBook(GDAX.OrderBookResponse orderBookResponse)
        {
            var orderBook = new OrderBook
            {
        ...
        private BinanceOrders[] GDAXOrdersToBinanceOrders(GDAX.OrderBook[] gdaxOrders)
        {
            var orderList = new List<BinanceOrders>();
